...
(ert-deftest test-casual-info-unicode-db-get ()
  (let ((casual-info-use-unicode-symbols nil))
    ...
    (should (string-equal (casual-info-unicode-db-get :rewind) "Previous"))
    (should (string-equal (casual-info-unicode-db-get :fast-forward-or-down) "Next/Down"))
    (should (string-equal (casual-info-unicode-db-get :rewind-or-up) "Previous/Up"))
    ...
    (should (string-equal (casual-info-unicode-db-get :up-arrow) "Previous"))
